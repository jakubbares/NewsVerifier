...
class SentenceComparator:
    ...
    def save_to_files(self):
        ...
        with open(os.path.join(self.saved_files_folder_name, f"entity_inverted_index.{self.file_name_suffix}"), "w") as fp:
            json.dump(self.entity_index, fp)
    ...
    def load_from_files(self):
        ...
        with open(os.path.join(self.loaded_files_folder_name, f"entity_inverted_index.{self.file_name_suffix}"), "r") as fp:
            self.entity_index = json.load(fp)
